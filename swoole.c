...
PHP_MINIT_FUNCTION(swoole)
{
    ...
    /** 
        * nanomsg socket type
        */
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_PULL", SW_SOCK_NN_PULL, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_PUSH", SW_SOCK_NN_PUSH, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_PAIR", SW_SOCK_NN_PAIR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_SUB", SW_SOCK_NN_SUB, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_PUB", SW_SOCK_NN_PUB, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_SURVEYOR", SW_SOCK_NN_SURVEYOR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_RESPONDENT", SW_SOCK_NN_RESPONDENT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_NN_BUS", SW_SOCK_NN_BUS, CONST_CS | CONST_PERSISTENT);
